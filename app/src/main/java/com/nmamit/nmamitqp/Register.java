            ...
            public void onClick(View v) {
                ...
                mAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        if(task.isSuccessful())
                        {
                            FirebaseAuth.getInstance().getCurrentUser().sendEmailVerification().addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void unused) {
                                    Toast.makeText(Register.this,"You are successfully Registered Verification Email Sent", Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(Register.this,"You are not Registered! Try again"+e.getMessage(),Toast.LENGTH_SHORT).show();
                    }
                });
